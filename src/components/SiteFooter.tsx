        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-white hover:text-gray-200 transition-colors inline-flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span> Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white hover:text-gray-200 transition-colors inline-flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span> About
                </Link>
              </li>
              <li>
                <Link href="/products" className="text-white hover:text-gray-200 transition-colors inline-flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span> Products
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-white hover:text-gray-200 transition-colors inline-flex items-center group">
                  <span className="mr-2 group-hover:mr-3 transition-all">→</span> Blog
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-white hover:text-gray-200 transition-colors inline-flex items-center group">
