    ...
    <div className="flex login-page">
      ...
      <div className="w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Welcome back to your gallery</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-5 h-5 text-[#AD5618] border-gray-300 rounded focus:ring-2 focus:ring-[#AD5618] focus:ring-2"
                  />
                  <label className="text-sm text-gray-700">Remember me</label>
                </div>
                <a href="#" className="text-sm text-[#AD5618] hover:text-[#91530A] transition-colors">
                  Forgot password?
                </a>
              </div>
              ...
              <div className="text-center pt-4">
                <p className="text-gray-600">
                  ...
                  <a href="/signup" className="text-[#AD5618] hover:text-[#91530A] font-semibold transition-colors">
                    Sign up here
                  </a>
                </p>
              </div>
      ...
      <div className="w-1/2 relative">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 right-20 w-64 h-64 bg-black/20 rounded-full blur-xl"></div>
          <div className="absolute bottom-20 left-20 w-80 h-80 bg-white/10 rounded-full blur-xl"></div>
          <div className="absolute top-1/2 right-10 w-48 h-48 bg-black/15 rounded-full blur-xl"></div>
        </div>
        ...
        <div className="absolute top-40 left-20 right-20">
          <h2 className="text-3xl font-bold mb-4 text-[#AD5618]">Discover Authentic Rwandan Art</h2>
          <p className=" text-lg leading-relaxed text-white">
            Immerse yourself in the rich cultural heritage of Rwanda through our curated collection of traditional crafts, 
            contemporary art, and handcrafted treasures.
          </p>
        </div>
      </div>
    </div>
