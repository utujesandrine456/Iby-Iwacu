        ...
        <div className="mb-8">
          <ol className="grid grid-cols-3 gap-4">
            <li className="flex items-center gap-3 bg-white rounded-xl border border-[#AD5618]/20 p-4 shadow-sm">
              <span className="w-8 h-8 rounded-full bg-gradient-to-br from-[#AD5618] to-[#91530A] text-white flex items-center justify-center font-semibold">1</span>
              <div>
                <div className="text-sm font-semibold text-gray-900">Personal</div>
                <div className="text-xs text-gray-500">Shipping details</div>
              </div>
            </li>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr,400px]">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-white/60 p-6 lg:p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Enter your contact and delivery information</p>
            </div>
